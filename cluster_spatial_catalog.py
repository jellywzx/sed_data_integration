        ...
        source_station_df = pd.DataFrame(
            {
                ...
                "source_station_temporal_span": _read_text_var(
                    ds,
                    "source_station_temporal_span",
                    size=n_source_stations,
                ),
                "source_station_time_coverage_start": _read_text_var(
                    ds,
                    "source_station_time_coverage_start",
                    size=n_source_stations,
                ),
                "source_station_time_coverage_end": _read_text_var(
                    ds,
                    "source_station_time_coverage_end",
                    size=n_source_stations,
                ),
                "source_station_summary": _read_text_var(
                    ds,
                    "source_station_summary",
                    size=n_source_stations,
                ),
                "source_station_comment": _read_text_var(
                    ds,
                    "source_station_comment",
                    size=n_source_stations,
                ),
                "source_station_variables_provided": _read_text_var(
                    ds,
                    "source_station_variables_provided",
                    size=n_source_stations,
                ),
                "source_station_data_limitations": _read_text_var(
                    ds,
                    "source_station_data_limitations",
                    size=n_source_stations,
                ),
                "source_station_declared_temporal_resolution": _read_text_var(
                    ds,
                    "source_station_declared_temporal_resolution",
                    size=n_source_stations,
                ),
