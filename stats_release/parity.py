...
LEGACY_TARGETS += _targets_for(
    ...
    [
        ...
        "figures/basin_status_by_merit_basin_area_presence.png",
        "figures/merit_basin_area_presence_counts.png",
        "figures/resolved_assignment_distance_filter_retention.png",
        ...
        "manual_review_largest_spatial_offsets.csv",
        "remote_sensing_exclusion_summary.csv",
        "remote_sensing_exclusion_summary.txt",
        "resolved_assignment_distance_filter_retention.csv",
        ...
        "spatial_match_status_by_merit_basin_area_presence.csv",
