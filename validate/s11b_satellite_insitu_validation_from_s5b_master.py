...
def _load_satellite_observations_from_s5b(
    ...
    # Overwrite cluster_uid / resolution with the linked counterparts so
    # satellite observations land in the same (cluster_uid, resolution)
    # groups as their linked in-situ records during pairing.
    if not raw.empty:
